...
class ImagenetDataset(Dataset):
    ...
    def __init__(self, root, transform=None, target_transform=None, num_classes=100):
        self.root = root
        ...
        self.onehot_targets = torch.from_numpy(encode_onehot(self.targets, self.num_classes)).float()
