...
from data.transform import train_transform, query_transform, encode_onehot
...
def load_data(root, num_query, num_train, batch_size, num_workers):
    ...
    train_dataset = CIFAR10('train', transform=train_transform())
    retrieval_dataset = CIFAR10('database', transform=query_transform())
...
class CIFAR10(Dataset):
    ...
    def init(root, num_query, num_train):
        ...
        CIFAR10.QUERY_TARGET = encode_onehot(targets[query_index], 10)
        CIFAR10.TRAIN_IMG = data[train_index, :]
        CIFAR10.TRAIN_TARGET = encode_onehot(targets[train_index], 10)
        CIFAR10.RETRIEVAL_IMG = data[retrieval_index, :]
        CIFAR10.RETRIEVAL_TARGET = encode_onehot(targets[retrieval_index], 10)

    def __init__(self, mode='train',
                 transform=None, target_transform=None, num_classes=10
                 ):
